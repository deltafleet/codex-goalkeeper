# Codex Goalkeeper Repository Instructions
...
Do not add plugin packaging, MCP servers, global databases, background daemons, or private Codex runtime hooks unless a future release explicitly changes scope.
